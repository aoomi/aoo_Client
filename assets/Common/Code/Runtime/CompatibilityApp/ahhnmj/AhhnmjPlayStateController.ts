...
export type AhhnmjPlayPhase = 'waiting' | 'playing' | 'settled' | 'ended';

export interface AhhnmjPlaySnapshot {
    phase: AhhnmjPlayPhase;
...
export class AhhnmjPlayStateController {
    private phase: AhhnmjPlayPhase = 'waiting';
    private hand: number[] = [];
    private availableOperations: number[] = [];
    private result: unknown = null;

    public constructor(private readonly runtime: AhhnmjRuntime) {}

    public refreshFromRoom(): AhhnmjPlaySnapshot {
    ...
    public consume(event: string, body: unknown): AhhnmjPlaySnapshot {
    ...
    private snapshot(): AhhnmjPlaySnapshot {
        return {
            phase: this.phase,
            hand: [...this.hand],
