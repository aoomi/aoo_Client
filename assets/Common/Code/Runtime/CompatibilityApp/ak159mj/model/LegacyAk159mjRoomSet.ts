...
export class LegacyAk159mjRoomSet {
  ...
  public OnStartRound(setRound) {
	...
	//指定位置获取卡牌
  public OnPosGetCard(pos, setPosInfo, normalMoCnt, gangMoCnt, liuPaiSize) {
		let setPos = this.allSetPosDict[pos];
		if (!setPos) {
		...
		this.dataInfo["liuPaiSize"] = liuPaiSize;
  ...
  public OnPosOpCard(serverPack) {
		...
		serverPack["liuPaiSize"] = liuPaiSize;
