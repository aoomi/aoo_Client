...
export type Ak159mjPlayPhase = 'waiting' | 'playing' | 'settled' | 'ended';

export interface Ak159mjPlaySnapshot {
    phase: Ak159mjPlayPhase;
...
export class Ak159mjPlayStateController {
    private phase: Ak159mjPlayPhase = 'waiting';
    private hand: number[] = [];
    private availableOperations: number[] = [];
    private result: unknown = null;

    public constructor(private readonly runtime: Ak159mjRuntime) {}

    public refreshFromRoom(): Ak159mjPlaySnapshot {
    ...
    public consume(event: string, body: unknown): Ak159mjPlaySnapshot {
    ...
    private snapshot(): Ak159mjPlaySnapshot {
        return {
            phase: this.phase,
            hand: [...this.hand],
