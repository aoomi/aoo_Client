...
export class LegacyPlatformEvents {
    ...
    public emit(type: string, data: Record<string, unknown> = {}): void {
        const causalId = typeof data.traceId === 'string' && data.traceId ? data.traceId : type;
        this.causalGuard.dispatch('platform', causalId, () => {
...
import { CausalEventGuard } from '../core/CausalEventGuard';
