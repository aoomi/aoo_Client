// @ts-nocheck
// Generated from the Creator 2.2.2 AYPDK logic by tools/migrate-aypdk-logic.mjs.
// Method bodies intentionally remain byte-for-byte equivalent apart from the class wrapper.
export interface AypdkRoomPolicy {
    GetRoomPaiXing(name: string): boolean;
}

export interface AypdkRoomSetSource {
    GetHandCard(): number[];
}

export interface AypdkGameLogicOptions {
    room?: AypdkRoomPolicy;
    roomSet?: AypdkRoomSetSource;
    onEvent?: (event: string) => void;
}

export class AypdkGameLogic {
    public handCardList = [];
    ...
    public readonly Room: AypdkRoomPolicy;
    public readonly RoomSet: AypdkRoomSetSource;
    private readonly onEvent: (event: string) => void;

    public constructor(options: AypdkGameLogicOptions = {}) {
