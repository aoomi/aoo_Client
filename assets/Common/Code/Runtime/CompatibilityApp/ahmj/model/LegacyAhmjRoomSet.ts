...
export class LegacyAhmjRoomSet {
  ...
  public OnSetWaiting(setPosList) {
  ...
  public OnPosNiao(pos, value, Type = "") {
		this.dataInfo["setPosList"][pos][Type] = value;
  ...
  public GetHuCardTypeInfo(selfPos) {
		...
		//把开的王牌加上
		if(this.get_jinJin() != 0){
			outCardIDList.push(this.get_jinJin());
		}else{
			outCardIDList.push(this.get_jin1());
		}
