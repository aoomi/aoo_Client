...
export type AfmjPlayPhase = 'waiting' | 'playing' | 'settled' | 'ended';

export interface AfmjPlaySnapshot {
    phase: AfmjPlayPhase;
...
export class AfmjPlayStateController {
    private phase: AfmjPlayPhase = 'waiting';
    private hand: number[] = [];
    private availableOperations: number[] = [];
    private result: unknown = null;

    public constructor(private readonly runtime: AfmjRuntime) {}

    public refreshFromRoom(): AfmjPlaySnapshot {
    ...
    public consume(event: string, body: unknown): AfmjPlaySnapshot {
    ...
    private snapshot(): AfmjPlaySnapshot {
        return {
            phase: this.phase,
            hand: [...this.hand],
