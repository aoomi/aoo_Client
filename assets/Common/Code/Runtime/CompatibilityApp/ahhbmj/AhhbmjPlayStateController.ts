...
export type AhhbmjPlayPhase = 'waiting' | 'playing' | 'settled' | 'ended';

export interface AhhbmjPlaySnapshot {
    phase: AhhbmjPlayPhase;
...
export class AhhbmjPlayStateController {
    private phase: AhhbmjPlayPhase = 'waiting';
    private hand: number[] = [];
    private availableOperations: number[] = [];
    private result: unknown = null;

    public constructor(private readonly runtime: AhhbmjRuntime) {}

    public refreshFromRoom(): AhhbmjPlaySnapshot {
    ...
    public consume(event: string, body: unknown): AhhbmjPlaySnapshot {
    ...
    private snapshot(): AhhbmjPlaySnapshot {
        return {
            phase: this.phase,
            hand: [...this.hand],
