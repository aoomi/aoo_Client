...
export type BdjhmjPlayPhase = 'waiting' | 'playing' | 'settled' | 'ended';

export interface BdjhmjPlaySnapshot {
    phase: BdjhmjPlayPhase;
...
export class BdjhmjPlayStateController {
    private phase: BdjhmjPlayPhase = 'waiting';
    private hand: number[] = [];
    private availableOperations: number[] = [];
    private result: unknown = null;

    public constructor(private readonly runtime: BdjhmjRuntime) {}

    public refreshFromRoom(): BdjhmjPlaySnapshot {
    ...
    public consume(event: string, body: unknown): BdjhmjPlaySnapshot {
    ...
    private snapshot(): BdjhmjPlaySnapshot {
        return {
            phase: this.phase,
            hand: [...this.hand],
