...
export type AqmjPlayPhase = 'waiting' | 'playing' | 'settled' | 'ended';

export interface AqmjPlaySnapshot {
    phase: AqmjPlayPhase;
...
export class AqmjPlayStateController {
    private phase: AqmjPlayPhase = 'waiting';
    private hand: number[] = [];
    private availableOperations: number[] = [];
    private result: unknown = null;

    public constructor(private readonly runtime: AqmjRuntime) {}

    public refreshFromRoom(): AqmjPlaySnapshot {
    ...
    public consume(event: string, body: unknown): AqmjPlaySnapshot {
    ...
    private snapshot(): AqmjPlaySnapshot {
        return {
            phase: this.phase,
            hand: [...this.hand],
