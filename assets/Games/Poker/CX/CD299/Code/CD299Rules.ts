...
export interface CD299RoomRules {
    roomDurationMinutes: 30 | 45 | 60;
    roundLimit: 10;
    maxPlayers: 8;
    startPlayers: 2 | 4 | 6;
...
export const CD299_DEFAULT_RULES: Readonly<CD299RoomRules> = Object.freeze({
    roomDurationMinutes: 30, roundLimit: 10, maxPlayers: 8, startPlayers: 2,
...
export function validateCD299Rules(r: CD299RoomRules): CD299RoomRules {
    ...
    if (!([30, 45, 60] as const).includes(r.roomDurationMinutes) || r.roundLimit !== 10
        ...
        || r.seatRetentionSeconds !== 120 || r.autoOperateAfterTimeouts !== 3
