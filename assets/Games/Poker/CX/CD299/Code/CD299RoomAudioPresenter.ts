...
const EFFECT_PATHS: Readonly<Record<CD299RoomSound, string>> = Object.freeze({
    deal: 'CD299/Audio/fapai', select: 'CD299/Audio/xuanpai',
    DROP: 'CD299/Audio/diu', FOLLOW: 'CD299/Audio/gen', REST: 'CD299/Audio/xiu',
    RAISE: 'CD299/Audio/da', ALL_IN: 'CD299/Audio/qiao',
});
...
export class CD299RoomAudioPresenter {
    ...
    public async playMusic(): Promise<boolean> {
        ...
        const clip = await this.load('CD299/Audio/bg');
