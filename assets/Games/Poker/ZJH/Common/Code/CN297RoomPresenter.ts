...
export class CN297RoomPresenter {
    ...
    private render(snapshot: CN297Snapshot): void {
        ...
        this.view.setActions(Object.freeze({
            ...
            canLook: ownTurn && !!local && !local.looked,
            canBet: ownTurn, canPreBet: snapshot.state === 'PLAYING' && !!local?.active,
            canFold: ownTurn, canCompare: ownTurn && snapshot.bettingRound >= snapshot.compareStartRound,
